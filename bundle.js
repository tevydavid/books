...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1),
	    books = __webpack_require__(160);
	BooksIndexItem = __webpack_require__(161);
	Welcome = __webpack_require__(162);
	...
	var BooksIndexItem = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      "div",
	      { className: "box" },
	      React.createElement("img", { className: "book-image", src: this.props.book.imageUrl }),
	      React.createElement(
	        "div",
	        { className: "book-info" },
	        React.createElement(
